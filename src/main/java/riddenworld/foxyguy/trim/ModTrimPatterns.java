...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> HARMONY = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(RiddenWorld.MOD_ID, "harmony"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.HARMONIC_SMITHING_TEMPLATE, HARMONY);
    }
